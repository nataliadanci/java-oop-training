...
class MousePanel extends JPanel implements MouseListener, MouseMotionListener {
   ...
   //================================================ instance variables
    ...
    public void mouseClicked(MouseEvent eventMouseClicked) {
        m_lastClickedX = eventMouseClicked.getX(); // Save the x coordinate of the click
        m_lastClickedY = eventMouseClicked.getY(); // Save the y coordinate of the click
    ...
    public void mouseMoved(MouseEvent eventMouseMoved) {
        m_lastMovedX = eventMouseMoved.getX();
        m_lastMovedY = eventMouseMoved.getY();
        this.repaint();
    }
