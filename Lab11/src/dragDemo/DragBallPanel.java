...
public class DragBallPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        System.out.println("Mouse pressed at coordinates: x=" + x + " y=" + y );
        ...
        System.out.println("Can you drag the ball? " + _canDrag);
    }//end mousePressed
    ...
    public void mouseDragged(MouseEvent e) {
        if (_canDrag) {   // True only if button was pressed inside ball.
            ...
            System.out.println("New coordinates: x= " + _ballX + " y=" + _ballY);
